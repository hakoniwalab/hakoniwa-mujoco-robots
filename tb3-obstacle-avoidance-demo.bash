...
# Launch a joystick-free MBody TurtleBot3 obstacle avoidance demo.
#
# Examples:
#   bash tb3-obstacle-avoidance-demo.bash
#   HAKO_TB3_MODEL=waffle bash tb3-obstacle-avoidance-demo.bash
#   HAKO_TB3_MODEL=waffle_pi bash tb3-obstacle-avoidance-demo.bash
#   HAKO_TB3_ENABLE_VIEWER=0 ACTIVATE_MODE=activate-only bash tb3-obstacle-avoidance-demo.bash

ACTIVATE_MODE=${ACTIVATE_MODE:-"immediate"}
LAUNCH_FILE=${LAUNCH_FILE:-"tb3-obstacle-avoidance-demo-launch.json"}
